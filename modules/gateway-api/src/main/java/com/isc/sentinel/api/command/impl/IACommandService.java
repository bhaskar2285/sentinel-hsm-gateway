...
public class IACommandService implements ThalesCommandService {
    private final CommandDispatcher dispatcher;
    @Override public String commandCode() { return "IA"; }
    @Override
    public Map<String, Object> execute(Map<String, Object> params) {
        GatewayResponse r = dispatcher.dispatch(GatewayCommand.builder()
            .op(OpCode.KEY_GEN_ZPK).vendorHint(HsmVendor.THALES).params(params).build());
