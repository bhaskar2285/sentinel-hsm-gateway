...
public class NCCommandService implements ThalesCommandService {

    private final CommandDispatcher dispatcher;

    @Override public String commandCode() { return "NC"; }

    @Override
    public Map<String, Object> execute(Map<String, Object> params) {
        GatewayResponse r = dispatcher.dispatch(GatewayCommand.builder()
            .op(OpCode.NET_HEALTH).vendorHint(HsmVendor.THALES).params(params).build());
        Map<String, Object> out = new HashMap<>(r.getResult());
        out.put("errCode", r.getErrCode());
