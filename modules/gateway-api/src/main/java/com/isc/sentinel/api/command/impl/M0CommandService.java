...
public class M0CommandService implements ThalesCommandService {
    private final CommandDispatcher dispatcher;
    @Override public String commandCode() { return "M0"; }
    @Override
    public Map<String, Object> execute(Map<String, Object> params) {
        GatewayResponse r = dispatcher.dispatch(GatewayCommand.builder()
            .op(OpCode.DATA_ENCRYPT).vendorHint(HsmVendor.THALES).params(params).build());
