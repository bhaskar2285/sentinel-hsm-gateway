...
public class A2CommandService implements ThalesCommandService {
    private final CommandDispatcher dispatcher;
    @Override public String commandCode() { return "A2"; }
    @Override
    public Map<String, Object> execute(Map<String, Object> params) {
        GatewayResponse r = dispatcher.dispatch(GatewayCommand.builder()
            .op(OpCode.KEY_COMPONENT_GEN).vendorHint(HsmVendor.THALES).params(params).build());
